(function() {
  ...
  window.plugins.favicon = {
    create: function() {
      var NeighborNetDB, angle, canvas, colprep, cos, ctx, dark, fav, light, newID, p, scale, sin, x, y;
      ...
      newID.name = 'anonymous';
      newID.favicon = fav;
      console.log('created ID11111111111111111111, ', newID.favicon);
      return NeighborNetDB = sdb.req(NeighborNetDBschema, function(nndb) {
        return NeighborNetDB.tr(nndb, ['LocalID'], 'readwrite').store('LocalID').add(newID);
      });
    }
  };
